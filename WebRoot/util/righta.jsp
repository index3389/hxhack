  ...
  <head>
	...
	<style type="text/css">
  	...
  	<c:if test="${ empty requestScope.right1}">
  		<jsp:forward page="../topic.do?method=topicRight3"></jsp:forward>
  	</c:if>
  <body>
    <div id="right_1">
    	<div class="right_3">
    		<div class="right_6"><img src="images/left/user1.gif" width="215px" border="0"/></div>
    	...
    	<div class="right_6"><img src="images/left/uer2.gif" width="215px" border="0"/></div>
    	<div class="right_3">
    		<div class="right_7"><img src="<%=path %>/images/left/jingping.jpg" width="215px" border="0" height="30px"/></div>
    		<c:choose>
