  ...
  <head>
	...
	<style type="text/css">
  	...
  	<c:if test="${ empty requestScope.right1}">
  		<jsp:forward page="../topic.do?method=downloadRight"></jsp:forward>
  	</c:if>
  <body>
    <div id="right_1">
    	<div class="right_3">
    		<div id="right_7"><img src="images/left/renmenxiazai.jpg" width="215px" border="0" height="30px"/></div>
    		<c:choose>
    			...
    			<c:otherwise>
    				<c:forEach var="r1" items="${ requestScope.right1}">
    					<div class="right_9"><a href="topic.do?method=getdownload&id=${ r1.downid}" target="_blank">
    						<%
								DownloadVO news0 = (DownloadVO)pageContext.getAttribute( "r1");
    	...
    	<div class="right_3">
    		<div class="right_7"><img src="images/left/zaixaipaihang.jpg" width="215px" border="0" height="30px"/></div>
    		<c:choose>
