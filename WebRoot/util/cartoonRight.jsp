  ...
  <head>
	...
	<style type="text/css">
  	...
  	<c:if test="${ empty requestScope.right1}">
  		<jsp:forward page="../topic.do?method=cartoonRight"></jsp:forward>
  	</c:if>
  <body>
    <div id="right_1">
    	<div class="right_3">
    		...
    		<c:choose>
    			...
    			<c:otherwise>
    				<c:forEach var="r1" items="${ requestScope.right1}">
    					<div class="right_9"><a href="topic.do?method=getsafety&id=${ r1.safetyid}" target="_blank">
    						<%
								SafetyVO news0 = (SafetyVO)pageContext.getAttribute( "r1");
    		...
    		<c:choose>
    			...
    			<c:otherwise>
    				<c:forEach var="r2" items="${ requestScope.right2}">
    					<div class="right_9"><a href="topic.do?method=getsafety&id=${ r2.safetyid}" target="_blank">
    						<%
								SafetyVO news1 = (SafetyVO)pageContext.getAttribute( "r2");
