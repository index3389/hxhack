...
<html>
  <head>
    ...
    <title>${ applicationScope.title} -- 后台管理 -- 添加管理员</title>   
	...
	<script type="text/javascript">
		...
		function ise()
		{
			...
			{
				ys = false;
						document.getElementById("is").innerHTML = "<font color='red'>不能含有中文</font>";
			}
			else if(u != "")
			{
  ...
  <jsp:include flush="true" page="../util/default_top.jsp"></jsp:include>
    ...
    <div id="basic_1">
    	...
    	<form action="init.do?method=add_admin" method="post" name="fm">
