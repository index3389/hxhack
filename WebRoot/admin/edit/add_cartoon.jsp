...
<div id="main">
	<table border="1" width="800px" align="center" rules="none">
		<form method="post" action="cartoon.do?method=addObj" name="fm" enctype="multipart/form-data">
			<tr>
				<td align="right">名称</td>
				<td width="200px"><input type="text" name="title" size="40"/></td>
				<td align="left">更新时间</td>
				<td>
					<input name="updateTime" size="15" type="text" onclick="SelectDate(this,'yyyy-MM-dd')" readonly="readonly"/>
				</td>
			</tr>
			<tr>
				...
				<td>
					<select class="hot" name="type">
						...
						<option value="1">加密破解</option>
						<option value="2">QQ动画</option>
						<option value="3">入侵攻击</option>
						<option value="4">后门木马</option>
						<option value="5">溢出程序</option>		
						<option value="6">原创发布</option>
					</select>
				</td>
			</tr>
			<tr>
