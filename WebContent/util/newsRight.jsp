  ...
  <head>
	...
	<style type="text/css">
  	...
  	<c:if test="${ empty requestScope.right1}">
  		<jsp:forward page="../topic.do?method=newsRight"></jsp:forward>
  	</c:if>
  <body>
    <div id="right_1">
    	<div class="right_3">
    		...
    		<c:choose>
    			...
    			<c:otherwise>
    				<c:forEach var="r1" items="${ requestScope.right1}">
    					<div class="right_9"><a href="topic.do?method=getnews&id=${ r1.newsid}" target="_blank">
    						<%
								NewsVO news0 = (NewsVO)pageContext.getAttribute( "r1");
    		...
    		<c:choose>
    			...
    			<c:otherwise>
    				<c:forEach var="r2" items="${ requestScope.right2}">
    					<div class="right_9"><a href="topic.do?method=getnews&id=${ r2.newsid}" target="_blank">
    						<%
								NewsVO news1 = (NewsVO)pageContext.getAttribute( "r2");
