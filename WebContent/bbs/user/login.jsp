...
<jsp:include flush="true" page="../../public/t.jsp"></jsp:include>
    <div id="main">
        ...
        <div id="wu">
        	您无权进行当前操作，原因如下：<br /><br />您所在的用户组(游客)无法进行此操作。
        </div>
        <form action="user.do?method=userLogin" method="post" name="fm">
        	<table width="60%">
            	<tr>
                    ...
                    <td align="left">
                    <input type="text" name="hackName" size="40" class="i"/>
                    </td>
                </tr>
                <tr>
                	<td align="center">密&nbsp;&nbsp;码</td>
                    <td align="left">
                    <input type="password" name="hackPass" size="40" class="i"/>
                    </td>
                </tr>
                <tr>
                	<td align="center">验证码</td>
                    <td align="left">
                    <input type="text" name="validate" size="28" class="i" onkeydown="on_enter1()"/>
                    <span id="vali"></span>&nbsp;
