...
<%@ page import="com.hbsoft.hack.vo.NewsVO" %>
...
<html>
  <head>
    ...
    <title>${ applicationScope.title}-新闻资讯</title>
  ...
  <body>
   ...
   <div class="main_news">
   		<div class="news_1">
   			<div class="news_3">
   				<div class="news_t">
   					<img src="images/util/n1.jpg" width="310px"/>
   					<c:choose>
   						...
   						<c:otherwise>
   							<table border="0" width="310px">
   								<c:forEach items="${ requestScope.news0}" var="n0">
   									<tr>
   										<td><a href="topic.do?method=getnews&id=${ n0.newsid}"> 										
   										<%
											NewsVO news0 = (NewsVO)pageContext.getAttribute( "n0");
   				...
   				<div class="news_t1">
   					<img src="images/util/2n.jpg"  width="310px"/>
   					<c:choose>
   						...
   						<c:otherwise>
   							<table border="0" width="310px">
   								<c:forEach items="${ requestScope.news1}" var="n1">
   									<tr>
   										<td><a href="topic.do?method=getnews&id=${ n1.newsid}">
   											<%
												NewsVO news1 = (NewsVO)pageContext.getAttribute( "n1");
   			...
   			<div class="news_3">
   				<div class="news_t">
   					<img src="images/util/n3.jpg"  width="310px"/>
   					<c:choose>
   						...
   						<c:otherwise>
   							<table border="0" width="310px">
   								<c:forEach items="${ requestScope.news2}" var="n2">
   									<tr>
   										<td><a href="topic.do?method=getnews&id=${ n2.newsid}">
   											<%
												NewsVO news2 = (NewsVO)pageContext.getAttribute( "n2");
   				...
   				<div class="news_t1">
   					<img src="images/util/n4.jpg"  width="310px"/>
   					<c:choose>
   						...
   						<c:otherwise>
   							<table border="0" width="310px">
   								<c:forEach items="${ requestScope.news3}" var="n3">
   									<tr>
   										<td><a href="topic.do?method=getnews&id=${ n3.newsid}">
   											<%
												NewsVO news3 = (NewsVO)pageContext.getAttribute( "n3");
